...
IUSE="+jmx-remote extra-webapps websockets"
...
use jmx-remote && EANT_BUILD_TARGET+=" extras-jmx-remote"
EANT_GENTOO_CLASSPATH="tomcat-servlet-api-${SAPI_SLOT},eclipse-ecj-${ECJ_SLOT}"
EANT_GENTOO_CLASSPATH_EXTRA="${S}/output/classes"
EANT_NEEDS_TOOLS="true"
# NOTE: 'gentoo' suffix removed, an OSGi library doesn't like it
EANT_EXTRA_ARGS="-Dversion=${PV} -Dversion.number=${PV} -Dcompile.debug=false"
...
src_install() {
	...
	use jmx-remote && java-pkg_dojar output/extras/catalina-jmx-remote.jar
	...
	cp "${FILESDIR}"/server.xml output/build/conf/server.xml || die
